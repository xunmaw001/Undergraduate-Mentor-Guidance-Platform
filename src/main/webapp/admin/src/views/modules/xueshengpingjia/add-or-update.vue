    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学生评价" prop="xueshengpingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学生评价"
                  v-model="ruleForm.xueshengpingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xueshengpingjia" label="学生评价" prop="xueshengpingjia">
                    <span>{{ruleForm.xueshengpingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueqi = true;
          ...
          if(o=='xueshengpingjia'){
            this.ruleForm.xueshengpingjia = obj[o];
	    this.ro.xueshengpingjia = true;
            continue;
          }
          if(o=='pingjiashijian'){
