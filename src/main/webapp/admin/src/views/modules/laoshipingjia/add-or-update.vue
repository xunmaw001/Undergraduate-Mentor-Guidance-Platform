    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="老师评价" prop="laoshipingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="老师评价"
                  v-model="ruleForm.laoshipingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.laoshipingjia" label="老师评价" prop="laoshipingjia">
                    <span>{{ruleForm.laoshipingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.xueshengxingming!=''&&json.xueshengxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xueqi/xueqi`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.xueqiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `laoshipingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.laoshipingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
