<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="研究方向介绍" prop="yanjiufangxiangjieshao">
          <el-input v-model="ruleForm.yanjiufangxiangjieshao" 
              placeholder="研究方向介绍" clearable  :readonly="ro.yanjiufangxiangjieshao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="研究方向介绍" prop="yanjiufangxiangjieshao">
              <el-input v-model="ruleForm.yanjiufangxiangjieshao" 
                placeholder="研究方向介绍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学术成果" prop="xueshuchengguo">
          <el-input v-model="ruleForm.xueshuchengguo" 
              placeholder="学术成果" clearable  :readonly="ro.xueshuchengguo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学术成果" prop="xueshuchengguo">
              <el-input v-model="ruleForm.xueshuchengguo" 
                placeholder="学术成果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学工号" prop="xuegonghao">
          <el-input v-model="ruleForm.xuegonghao" 
              placeholder="学工号" clearable  :readonly="ro.xuegonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学工号" prop="xuegonghao">
              <el-input v-model="ruleForm.xuegonghao" 
                placeholder="学工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="志愿顺序" prop="zhiyuanshunxu">
          <el-select v-model="ruleForm.zhiyuanshunxu" placeholder="请选择志愿顺序">
            <el-option
                v-for="(item,index) in zhiyuanshunxuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="志愿顺序" prop="zhiyuanshunxu">
	      <el-input v-model="ruleForm.zhiyuanshunxu"
                placeholder="志愿顺序" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	yanjiufangxiangjieshao : false,
	gerenjianjie : false,
	xueshuchengguo : false,
	zhaopian : false,
	xuegonghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yanjiufangxiang = true;
          ...
          if(o=='yanjiufangxiangjieshao'){
            this.ruleForm.yanjiufangxiangjieshao = obj[o];
	    this.ro.yanjiufangxiangjieshao = true;
            continue;
          }
          if(o=='gerenjianjie'){
	    ...
	    this.ro.gerenjianjie = true;
          ...
          if(o=='xueshuchengguo'){
            this.ruleForm.xueshuchengguo = obj[o];
	    this.ro.xueshuchengguo = true;
            continue;
          }
          if(o=='zhaopian'){
	    ...
	    this.ro.zhaopian = true;
          ...
          if(o=='xuegonghao'){
            this.ruleForm.xuegonghao = obj[o];
	    this.ro.xuegonghao = true;
            continue;
          }
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='zhiyuanshunxu'){
            this.ruleForm.zhiyuanshunxu = obj[o];
	    this.ro.zhiyuanshunxu = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.xuegonghao!=''&&json.xuegonghao){
              		this.ruleForm.xuegonghao = json.xuegonghao
		}
		if(json.xueshengxingming!=''&&json.xueshengxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.zhiyuanshunxuOptions = "第一志愿,第二志愿,第三志愿".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `wodexuesheng/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wodexuesheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wodexueshengCrossAddOrUpdateFlag = false;
                  this.parent.search();
