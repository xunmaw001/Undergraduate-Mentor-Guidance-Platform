<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="导师组" prop="daoshizu">
          <el-select v-model="ruleForm.daoshizu" placeholder="请选择导师组">
            <el-option
                v-for="(item,index) in daoshizuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="导师组" prop="daoshizu">
	      <el-input v-model="ruleForm.daoshizu"
                placeholder="导师组" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="研究方向" prop="yanjiufangxiang">
          <el-select v-model="ruleForm.yanjiufangxiang" placeholder="请选择研究方向">
            <el-option
                v-for="(item,index) in yanjiufangxiangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="研究方向介绍" prop="yanjiufangxiangjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="研究方向介绍"
                  v-model="ruleForm.yanjiufangxiangjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yanjiufangxiangjieshao" label="研究方向介绍" prop="yanjiufangxiangjieshao">
                    <span>{{ruleForm.yanjiufangxiangjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='daoshizu'){
            this.ruleForm.daoshizu = obj[o];
	    this.ro.daoshizu = true;
            continue;
          }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.daoshizuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.yanjiufangxiangOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
