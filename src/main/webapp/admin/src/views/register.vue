  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">本科生导师指导平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">学工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xuegonghao" class="input" type="text" placeholder="学工号">
			   </div>
			 </div> -->
			<el-form-item label="学工号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuegonghao" autocomplete="off" placeholder="学工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='daoshi'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='daoshi'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='daoshi'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<!-- <div v-if="tableName=='daoshi'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xueshuchengguo" class="input" type="text" placeholder="学术成果">
			   </div>
			 </div> -->
			<el-form-item label="学术成果" class="input" v-if="tableName=='daoshi'">
			  <el-input v-model="ruleForm.xueshuchengguo" autocomplete="off" placeholder="学术成果"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
      if((!this.ruleForm.xuegonghao) && `xuesheng` == this.tableName){
      ...
      if(`daoshi` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
