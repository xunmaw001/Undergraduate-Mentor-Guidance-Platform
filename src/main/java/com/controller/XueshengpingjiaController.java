...
public class XueshengpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengpingjiaEntity xueshengpingjia, 
		...
		if(tableName.equals("xuesheng")) {
			xueshengpingjia.setXuegonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("daoshi")) {
			xueshengpingjia.setDaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
