...
public class XueshengchengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengchengjiEntity xueshengchengji, 
		...
		if(tableName.equals("xuesheng")) {
			xueshengchengji.setXuegonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("daoshi")) {
			xueshengchengji.setDaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
